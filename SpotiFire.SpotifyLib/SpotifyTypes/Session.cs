...
namespace SpotiFire.SpotifyLib
{
    ...
    internal class Session : ISession
    {
        ...
        public IPlaylist Inbox
        {
            get
            {
                lock (libspotify.Mutex)
                    return Playlist.Get(this, libspotify.sp_session_inbox_create(sessionPtr));
            }
        }
        ...
        private void GetPopularCallback(IntPtr result, IntPtr userData)
        {
            lock (popularLock)
            {
